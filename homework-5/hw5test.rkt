...
(define tests
  (test-suite
   ...
   (check-equal? (eval-exp (mlet "x" (int 1) (mlet "y" (int 10) (add (var "y") (var "x"))))) (int 11) "nested mlet test")

   (check-equal? (eval-exp (mlet "x" (int 1) (mlet "x" (int 10) (add (int 5) (var "x"))))) (int 15) "nested mlet shadow test")
   ...
   (check-equal? (compute-free-vars (fun #f "x" (add (var "x") (var "y")))) (fun-challenge #f "x" (add (var "x") (var "y")) (set "y")) "compute-free-vars test")

   (check-equal? (compute-free-vars (fun #f "x" (mlet "y" (int 1) (add (var "x") (var "y"))))) (fun-challenge #f "x" (mlet "y" (int 1) (add (var "x") (var "y"))) (set)) "compute-free-vars test")

   (check-equal? (compute-free-vars (call (closure '() (fun #f "x" (add (var "x") (int 7)))) (int 1))) (call (closure '() (fun-challenge #f "x" (add (var "x") (int 7)) (set))) (int 1)) "compute-free-vars test")
   ...
   (check-equal? (eval-exp-c (mlet "x" (int 1) (mlet "y" (int 10) (add (var "y") (var "x"))))) (int 11) "nested mlet test")

   (check-equal? (eval-exp-c (mlet "x" (int 1) (mlet "x" (int 10) (add (int 5) (var "x"))))) (int 15) "nested mlet shadow test")
   ...
   (check-equal? (eval-exp-c (mlet* (list (cons "x" (int 10)) (cons "y" (add (int 5) (var "x")))) (var "y"))) (int 15) "mlet* test")
